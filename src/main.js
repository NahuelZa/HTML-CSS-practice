...
`;
    // Crear un nuevo marcador y abrir un popup con el nombre del lugar
    marcadorActual = L.marker([lat, lon])
        .addTo(map)
...
async function obtenerClima(lat, lon) {
    // URL de Open-Meteo pidiendo temperatura actual, velocidad del viento y código de clima
...
formulario.addEventListener('submit', async (event) => {
    // ¡MUY IMPORTANTE! Evita que la página se recargue por defecto
    event.preventDefault();
    // Aquí ejecutas la función de búsqueda de Nominatim
